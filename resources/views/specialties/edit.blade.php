      ...
      <div class="card-body">
            ...
            <form action="{{ url('/especialidades/'.$specialty->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="tex" name="name" class="form-control" value="{{ old('name', $specialty->name) }}" required>
                </div>

                <div class="form-group">
                    <label for="description">Descripción</label>
                    <input type="tex" name="description" class="form-control" value="{{ old('description', $specialty->description) }}">
                </div>
